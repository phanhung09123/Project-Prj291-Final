        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Manage <b>Wines</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Wine</span></a>
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${o.price} $</td>
                                <td>
                                    <a href="loadWine?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                ...
                <div class="modal-content">
                    <form action="add" method="post">
                        <div class="modal-header">						
                            <h4 class="modal-title">Add Wines</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Year</label>
                                <textarea name="year" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Price</label>
